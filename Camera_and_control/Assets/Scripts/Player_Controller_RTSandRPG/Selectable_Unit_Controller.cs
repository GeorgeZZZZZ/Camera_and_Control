...
public class Selectable_Unit_Controller : AIPath_For_Rigidbody_From_AstarPathfindingProject {
	...
	new void Start (){
		...
		if (GetComponent ("Player_Camera_Controller_RTS_RPG") != null) {
			speed = GetComponent <Player_Camera_Controller_RTS_RPG> ().Player_Normal_Speed;
			Run_Speed = GetComponent <Player_Camera_Controller_RTS_RPG> ().Player_Run_Speed;
			turningSpeed = GetComponent <Player_Camera_Controller_RTS_RPG> ().Player_Turnning_Speed;
		}
